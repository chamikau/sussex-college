    ...
    strategies: {
      cookie: {
        ...
        endpoints: {
          ...
          login: {url: process.env.API_URL + '/login?portal=admin', method: 'post'},
          logout: {url: process.env.API_URL + '/logout?portal=admin', method: 'post'},
          user: {url: process.env.API_URL + '/api/admin/profile?portal=admin', method: 'get'}
        },
      }
    },
    redirect: {
