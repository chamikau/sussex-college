    ...
    <div class="contents">
      <div class="row">
        ...
        <div class="col-md-auto mt-3 mx-3 ms-auto d-print-none">
          <div class="btn-list">
            <NuxtLink class="btn btn-primary"  :to="`/admin/courses/edit-course/${$route.params.id}/edit-contents/create`">
        ...
        <div class="container-xl">
          ...
          <div class="row">
            <div v-for="content in contents" class="col-sm-6 col-lg-6 mb-3 ">
              <div class="card card-sm cursor-pointer" @click="goToEditContents(content.id)">
                <div class="card-body">
...
export default {
  ...
  methods: {
    async goToEditContents(id) {
      await this.$router.push(`/admin/courses/edit-course/${this.$route.params.id}/edit-contents/${id}/general`)
    },
    async getCourses() {
