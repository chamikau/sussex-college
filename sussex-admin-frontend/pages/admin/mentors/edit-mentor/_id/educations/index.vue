    ...
    <div class="contents">
      <div class="row">
        ...
        <div class="col-md-auto mt-3 mx-3 ms-auto d-print-none">
          <div class="btn-list">
            <NuxtLink class="btn btn-primary"  :to="`/admin/mentors/edit-mentor/${$route.params.id}/educations/create`">
      ...
      <div class="page-body">
        <div class="container-xl">
          ...
          <div class="row">
            <div v-for="education in educations" class="col-sm-6 col-lg-6 mb-3 ">
                  ...
                  <div class="row align-items-center">
                    ...
                    <span class="col-md-2">
                      <span class="avatar badge bg-x text-white">
                        {{ education.university_name.slice(0,3) }}
                      </span>
                    </span>
                    </div>
                    <div class="col">
                      <div class="fw-bold">
                      <span v-if="education.university_name.length >= 40">
                        {{ education.university_name.slice(0,40) }}...
                      </span>
                        <span v-else>
                      ...
                      <span v-if="education.course_name.length >= 40">
                        {{ education.course_name.slice(0,40) }}...
                      </span>
                        <span v-else>
                    ...
                    <span class="mb-5" style="display: flex; justify-content: flex-end;">
                      <span>
                       <a class="btn btn-sm btn-icon" @click="goToEditEducations(education.id)" aria-label="">
              ...
              <div v-if="deleteEducationData" class="modal modal-blur fade show slow-fade" id="modal-danger" tabindex="-1" style="display: block;" aria-modal="true" role="dialog">
...
export default {
  ...
  methods: {
    async goToEditEducations(id) {
      await this.$router.push(`/admin/mentors/edit-mentor/${this.$route.params.id}/educations/${id}/general`)
    },
    async getMentors() {
      this.mentors = (await this.$axios.$get(`/api/admin/mentors/${this.$route.params.id}`)).data
      this.educations = this.mentors.mentor_education
    },
    deletePopUp(){
    ...
    deleteData(id){
      try {
        this.$axios.$delete(`/api/admin/educations-records/${id}`);
