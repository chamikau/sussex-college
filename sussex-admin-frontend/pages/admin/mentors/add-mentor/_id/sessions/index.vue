    ...
    <div class="contents">
      <div class="row">
        ...
        <div class="col-md-auto mt-3 mx-3 ms-auto d-print-none">
          <div class="btn-list">
            <NuxtLink class="btn btn-primary"  :to="`/admin/mentors/add-mentor/${$route.params.id}/sessions/create`">
        ...
        <div class="container-xl">
          ...
          <div class="row">
            <div v-for="session in sessions" class="col-sm-6 col-lg-6 mb-3 ">
              ...
              <div v-if="deleteSessionData" class="modal modal-blur fade-in show" id="modal-danger" tabindex="-1" style="display: block;" aria-modal="true" role="dialog">
...
export default {
  ...
  methods: {
    async goToEditSessions(id) {
      await this.$router.push(`/admin/mentors/add-mentor/${this.$route.params.id}/sessions/${id}/general`)
    },
    async getMentors() {
      try {
