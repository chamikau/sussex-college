    ...
    <div class="contents">
      <div class="row">
        ...
        <div class="col-md-auto mt-3 mx-3 ms-auto d-print-none">
          <div class="btn-list">
            <NuxtLink class="btn btn-primary"  :to="`/admin/mentors/add-mentor/${$route.params.id}/educations/create`">
...
export default {
  ...
  methods: {
    async goToEditEducations(id) {
      await this.$router.push(`/admin/mentors/add-mentor/${this.$route.params.id}/educations/${id}/general`)
    },
    async getMentors() {
