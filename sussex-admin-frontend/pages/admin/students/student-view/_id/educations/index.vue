  ...
  <div id="tab-1" class="card tab-pane active show">
    ...
    <div class="page-body">
      <div class="container-xl">
        <p v-if="educations.length === 0" class="title fs-3 text-center">No records available</p v-if="educations.length === 0">
        <div class="row">
...
export default {
  ...
  methods: {
    async goToViewEducations(id) {
      await this.$router.push(`/admin/students/student-view/${this.$route.params.id}/educations/${id}/general`)
    },
