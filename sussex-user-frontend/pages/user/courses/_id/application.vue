      ...
      <div class="page-header d-print-none">
        ...
        <div class="row g-2 align-items-center">
          ...
          <div class="col-md-2 d-flex flex-row-reverse">
            <button v-if="user_id_and_applicant_list_match === false" class="btn btn-primary"  @click="applyPopUp">Enroll Now</button>
            ...
            <div class="col-md-8">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-body">
                      <div v-for="content in contents" :key="content.id" class="accordion" role="tablist">
                        <div class="accordion-item">
                          <div class="accordion-header" role="tab">
                        <span class="accordion-button collapsed"
                              data-bs-toggle="collapse"
                              data-bs-target="#content.content_name"
                              aria-expanded="false"
                              @click="toggleAccordion(content.id)">
<!--                          <span class="row">-->
                            <span class="col-md-7">
                          ...
                          <div :id="content.content_name" class="accordion-collapse collapse" :class="{ show: activeAccordion === content.id }">
      ...
      <div v-if="applyCourseData" class="modal modal-blur fade-in show" id="modal-success" tabindex="-1" style="overflow: hidden; padding-right: 16px;display: block;" aria-modal="true" role="dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
              ...
              <div class="text-muted">
                Please review the information added to your profile carefully before proceeding. Once you click 'Apply' your application will be submitted, and the information added in your profile will be shared with our administrators. Are you sure you want to proceed with your application?              </div>
            </div>
            <div class="modal-footer">
              <div class="w-100">
                <div class="row">
                  ...
                  <div class="col">
                    <a @click.stop="enrolForCourse" class="btn btn-primary w-100" data-bs-dismiss="modal">
                      Enroll
                    </a>
                  </div>
                </div>
...
export default {
  ...
  methods:{
    toggleAccordion(contentId) {
      this.activeAccordion = this.activeAccordion === contentId ? null : contentId;
    },
    backToPage(){
