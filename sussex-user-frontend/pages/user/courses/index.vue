    ...
    <div class="container-xl">
      <div class="page-header d-print-none">
        <ul class="breadcrumb mb-1">
          <li><a>Courses</a></li>
          <li><a>Courses List</a></li>
        </ul>
        <div class="row g-2 align-items-center">
          <div  class="col d-flex align-items-center">
            <span class="fw-bold fs-1">Courses List</span>
          </div>
          <div class="card">
...
export default {
  ...
  methods: {
    async goToViewDetails(props) {
      await this.$router.push(`/user/courses/${props.record.id}/application`)
    },
    async getCourses(page = 1, sort = '', search = '', per_page = 15,) {
      try {
        this.attributes.api_response = await this.$axios.$get('/api/student/courses',
          {
            params: {
              per_page: per_page,
              page: page,
