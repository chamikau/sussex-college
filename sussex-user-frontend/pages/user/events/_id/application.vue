<template>
  <div class="page">
    <div class="container-xl">
      <div class="page-header d-print-none">
        <ul class="breadcrumb mb-1">
          ...
          <li><a href="#" @click="$router.back()">Events List</a></li>
    ...
    <div class="page-body">
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-md-2 ms-4 mb-4  ms-md-auto">
                      <div class="d-flex flex-row-reverse">
                        <button v-if="user_id_and_applicant_list_match === false" class="btn btn-primary" @click="applyPopUp">Register</button>
      ...
      <div v-if="applyEventData" class="modal modal-blur fade-in show" id="modal-success" tabindex="-1" style="display: block;" aria-modal="true" role="dialog">
            ...
            <div class="modal-footer">
              <div class="w-100">
                <div class="row">
                  ...
                  <div class="col">
                    <a @click.stop="registerForEvent" class="btn btn-primary w-100" data-bs-dismiss="modal">
                      Register
                    </a>
                  </div>
                </div>
