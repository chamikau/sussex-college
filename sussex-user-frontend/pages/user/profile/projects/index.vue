    ...
    <div class="contents">
      <div class="row">
        ...
        <div class="col-md-auto mt-3 mx-3 ms-auto d-print-none">
          <div class="btn-list">
            <NuxtLink class="btn btn-primary" to="/user/profile/projects/create">
        ...
        <div class="container-xl">
          ...
          <div class="row">
            <div v-for="project in projects" class="col-sm-5 col-lg-5 mb-3 ">
                ...
                <div class="card-body">
                  <div class="row align-items-center">
                    ...
                    <span class="mb-5" style="display: flex; justify-content: flex-end;">
                      <span>
                       <a class="btn btn-sm btn-icon" @click.stop="goToEditProjects(project.id)" aria-label="">
              ...
              <div v-if="deleteProjectData" class="modal modal-blur fade-in show" id="modal-danger" tabindex="-1" style="display: block;" aria-modal="true" role="dialog">
                    ...
                    <div class="modal-footer">
                      <div class="w-100">
                        <div class="row">
                          ...
                          <div class="col">
                            <a @click.stop="deleteData(project.id)" class="btn btn-danger w-100" data-bs-dismiss="modal">
                              Delete
                            </a>
                          </div>
                        </div>
...
export default {
  ...
  methods: {
    async goToEditProjects(id) {
      await this.$router.push(`/user/profile/projects/${id}/general`)
    },
    ...
    deletePopUp(){
      this.deleteProjectData = true;
    },
    deleteData(id){
      try {
        this.$axios.$delete(`/api/student/projects-records/${id}`);
        this.projects = this.projects.filter(project => project.id !== id);
        this.$errorToast('Successfully deleted')
        this.deleteProjectData = false;
      } catch (error) {
        return error;
      }
    },
