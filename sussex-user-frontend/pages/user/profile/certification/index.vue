    ...
    <div class="contents">
      <div class="row">
        ...
        <div class="col-md-auto mt-3 mx-3 ms-auto d-print-none">
          <div class="btn-list">
            <NuxtLink class="btn btn-primary" to="/user/profile/certification/create">
        ...
        <div class="container-xl">
          ...
          <div class="row">
            <div v-for="certification in certifications" class="col-sm-5 col-lg-5 mb-3 ">
                ...
                <div class="card-body">
                  <div class="row align-items-center">
                    ...
                    <span class="mb-5" style="display: flex; justify-content: flex-end;">
                      <span>
                       <a class="btn btn-sm btn-icon" @click.stop="goToEditCertifications(certification.id)" aria-label="">
              ...
              <div v-if="deleteCertificationData" class="modal modal-blur fade-in show" id="modal-danger" tabindex="-1" style="display: block;" aria-modal="true" role="dialog">
                    ...
                    <div class="modal-footer">
                      <div class="w-100">
                        <div class="row">
                          ...
                          <div class="col">
                            <a @click.stop="deleteData(certification.id)" class="btn btn-danger w-100" data-bs-dismiss="modal">
                              Delete
                            </a>
                          </div>
                        </div>
...
export default {
  ...
  methods: {
    async goToEditCertifications(id) {
      // await this.$setGlobalOrganization(props.record.id)
      await this.$router.push(`/user/profile/certification/${id}/general`)
    },
    ...
    deletePopUp(){
      this.deleteCertificationData = true;
    },
    deleteData(id){
      try {
        this.$axios.$delete(`/api/student/certifications-records/${id}`);
        this.certifications = this.certifications.filter(certification => certification.id !== id);
        this.$errorToast('Successfully deleted')
        this.deleteCertificationData = false;
      } catch (error) {
        return error;
      }
    },
